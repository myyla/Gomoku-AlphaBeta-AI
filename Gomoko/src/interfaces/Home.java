...
public class Home extends javax.swing.JFrame {
    ...
    public Home() throws SQLException, ClassNotFoundException {
         ...
         * si la partie est terminee ou non
         * ********************************************************************/
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(idPartie == 0)
        {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Enregistre", "Bien enregistree !", JOptionPane.INFORMATION_MESSAGE);
            } catch (SQLException ex) {
                Logger.getLogger(Home.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        else
        {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Modifie", "Bien modifie !", JOptionPane.INFORMATION_MESSAGE);
            } catch (SQLException ex) {
                Logger.getLogger(Home.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
